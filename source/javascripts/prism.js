...
Prism.languages.ruby = {
  ...
  'boolean': /\b(true|false)\b/g,
  'keyword': /\b(alias|and|BEGIN|begin|break|case|class|define_method|defined|do|each|else|elsif|END|ensure|for|if|in|module|new|next|nil|not|or|raise|redo|rescue|retry|return|self|super|then|throw|undef|unless|until|when|while|yield)\b/g,
